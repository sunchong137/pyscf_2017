...
from ftlanczos import FT_lanczos_E as ftl_e
...
def kernel_ft(h1e, g2e, norb, nelec, T, M = 60, ncycle = 20): # finite temperature
    h2e = absorb_h1e(h1e, g2e, norb, nelec, .5)
    na = cistring.num_strings(norb, nelec//2)
    ci0 = numpy.zeros((na,na))
    ci0[0,0] = 1
    ...
    E = ftl_e(hop, ci0.reshape(-1), T, M, ncycle)
    return E
