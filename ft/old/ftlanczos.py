...
def FT_lanczos_E(hop, v0, T, kB=1, m=60, nsamp=50, Min_b=10e-5, Min_m=40, norm = np.linalg.norm):
...
def FT_Lanczos_1rdms(qud, hop, v0, T, kB=1, m=60, nsamp=50, Min_b=10e-5, Min_m=30, norm=bp.linalg.norm)
    r'''return the 1st order reduced density matrix
