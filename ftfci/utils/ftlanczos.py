...
def ftlan_E1c(hop, v0, T, m=40, Min_b=1e-15, Min_m=3, kB=1, norm = np.linalg.norm):
...
def ftlan_rdm1s1c(qud, hop, v0, T, norb, m=60, Min_b=1e-15, Min_m=2, kB=1, norm=np.linalg.norm):
    r'''1 step lanczos
...
def ftlan_rdm12s1c(qud, hop, v0, T, norb, m=60, Min_b=1e-15, Min_m=3, kB=1, norm=np.linalg.norm):
    r'''1 step lanczos
