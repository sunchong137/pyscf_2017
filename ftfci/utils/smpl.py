...
def ft_ismpl_rdm12s(qud, hop, ci0, T, norb, nw=25, nsamp=100, M=50,\
         dr=0.5, gen_prof=False, prof_file=None, Hdiag=None,\
         verbose=0, **kwargs):
    ...
    ar =  (1.* Nar)/(1.* nsamp)
    log.info("Acceptance ration for Warming-up is %6.6f"%ar)
